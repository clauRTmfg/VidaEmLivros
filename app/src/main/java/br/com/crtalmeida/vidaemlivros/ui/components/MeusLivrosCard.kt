...
import br.com.crtalmeida.vidaemlivros.util.sampleLivroComImagem
import br.com.crtalmeida.vidaemlivros.util.sampleLivroSemImagem
...
@Preview
@Composable
fun MeusLivrosCardWithImagePreview() {
    VidaEmLivrosTheme {
        MeusLivrosCard(
